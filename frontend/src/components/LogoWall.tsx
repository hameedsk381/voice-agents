...
const logos = [
  { name: "FinServ", tag: "FINTECH" },
  { name: "HealthBridge", tag: "HEALTH" },
  { name: "ScaleVox", tag: "TELECOM" },
  { name: "PayFlow", tag: "PAYMENTS" },
  { name: "MediConnect", tag: "HEALTH" },
  { name: "QuickCollect", tag: "DEBT" },
  { name: "LeadPrime", tag: "SALES" },
  { name: "DialWorks", tag: "CRM" },
];
